...
def start_workout(target_reps=10):
    ...
    UPPER_THRESH, LOWER_THRESH, REVERSAL_TOLERANCE = 150, 50, 20
            ...
            if results.pose_landmarks:
                ...
                if avg_sway > 35:
                    if current_rep_form == "Good":
                        ...
                        bad_reps_list.append(f"Rep #{good_reps+bad_reps}: Swinging back too far.")
                    warning_text, color = "WARNING: SWINGING!", (0, 0, 255)
                ...
                if stage == "Waiting...":
                    ...
                    if avg_angle <= LOWER_THRESH:
                        stage, extreme_angle = "letting_up", avg_angle
                    elif extreme_angle < UPPER_THRESH - 20 and avg_angle > extreme_angle + REVERSAL_TOLERANCE:
                        if current_rep_form == "Good":
                            current_rep_form, bad_reps = "Bad", bad_reps + 1
                            bad_reps_list.append(f"Rep #{good_reps+bad_reps}: Half rep! Pull lower.")
                        stage, extreme_angle = "letting_up", avg_angle
                    ...
                    if avg_angle >= UPPER_THRESH:
                        ...
                        stage, current_rep_form, rep_start_time, extreme_angle = "pulling_down", "Good", time.time(), avg_angle
                    elif extreme_angle > LOWER_THRESH + 20 and avg_angle < extreme_angle - REVERSAL_TOLERANCE:
                        if current_rep_form == "Good":
                            current_rep_form, bad_reps = "Bad", bad_reps + 1
                            bad_reps_list.append(f"Rep #{good_reps+bad_reps}: Half rep! Let it all the way up.")
                        stage, extreme_angle = "pulling_down", avg_angle
    ...
    plot_analytics(angles_history, rep_durations, 'LAT PULLDOWN: TIME PER REP', 'LAT PULLDOWN: ELBOW FLEXION', bad_reps_list)